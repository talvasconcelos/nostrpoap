import math
from .geohash import gh_decode_exactly
...
def geohash_haversine_distance(geohash_1, geohash_2):
    ...
    lat_1, lon_1, _, _ = gh_decode_exactly(geohash_1)
    lat_2, lon_2, _, _ = gh_decode_exactly(geohash_2)
    ...
    a = math.sin(delta_phi / 2.0) * math.sin(delta_phi / 2.0) + math.cos(
        phi_1
